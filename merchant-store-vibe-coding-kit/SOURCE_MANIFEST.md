...
|---|---|---|
| `merchant-store-master(1).zip` | Canonical PingBusiness merchant-store UI; supersedes every prior `estore-ui` package. | `a2b7d90232ab420e11f71c67761bd432d6d0f06e40e0f94a6d99e1e57a02c0da` |
| `pingbiz-master(26).zip` | Canonical PingBusiness source package; current `estore-app` is `/app/estore/app.py` with its Dockerfile and requirements in the same directory. | `8543ba44f4abbe776961c3b0fafda0fe4f051beabccbbf80d941801b8a3140aa` |
